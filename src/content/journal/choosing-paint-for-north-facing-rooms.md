---
title: Choosing paint for north-facing rooms
description: North-facing rooms get the coolest, most consistent light of any room in the house, which makes paint selection tricky. Here's how we approach it.
hero: /images/gallery-wall.png
...
Hold a paint chip up in a north-facing room and your eye will read it cooler than it is. The fix isn't to compensate by picking a bright warm tone, which swings the other way. Instead, look for warm neutrals with a hint of yellow or pink undertone, and accept that the chip will look a touch *too* warm in the store.

## Mid-tones over pale or saturated

The mistake we see most often is reaching for a pale off-white to "brighten" the room. Pale colors need light to come alive, and that's exactly what north-facing rooms don't have. Mid-tone neutrals like soft taupes, muted greens, and warm greiges hold their character even when the light is flat.
